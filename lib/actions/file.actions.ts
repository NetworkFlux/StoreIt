...
export const uploadFile = async ({ file, ownerId, accountId, path }: UploadFileProps) => {
  ...
  try {
    ...
    const bucketFile = await storage.createFile(appwriteConfig.bucketIt, ID.unique(), inputFile);
    ...
    const newFile = await databases.createDocument(
      ...
      await storage.deleteFile(appwriteConfig.bucketIt, bucketFile.$id);
